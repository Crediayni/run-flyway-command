...
A GitHub Action that will run [Flyway](https://flywaydb.org/) against a specified database. Flyway must be installed in order for this Action to work. The [setup-flyway](https://github.com/Crediayni/setup-flyway) Action can be used for that purpose.
  ...
  migrate-database:
    ...
    steps:
      ...
      - name: Run Flyway Migrations
        ...
        uses: Crediayni/run-flyway-command@v1.5.0
        with:
